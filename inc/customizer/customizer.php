...
function goedemorgen_enqueue_custom_controls_js() {
    wp_enqueue_script( 'goedemorgen-customize-controls', GOEDEMORGEN_DIR_URI . '/inc/customizer/js/customize-controls.js', array( 'customize-controls' ) );
}
...
function goedemorgen_customize_preview_js() {
	wp_enqueue_script( 'goedemorgen-customize-preview', GOEDEMORGEN_DIR_URI . '/inc/customizer/js/customize-preview.js', array( 'jquery', 'customize-preview' ), '20151215', true );
}
